                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            <form action="{{route('create-po')}}" method="post">
                                @csrf
                                <table class="table table-hover table-bordered" id="myUL">
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="suplier_id" id="suplier_id" value="{{$suplier->id}}">
                                                <input type="hidden" name="statusmat" id="statusmat" value="pending">
