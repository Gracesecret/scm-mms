...
<div class="col-md-12">
    <div class="col-md mb-3">
        <ul class="nav nav-pills justify-content-start">
            <li class="nav-item">
                <a class="nav-link active bg-transparent text-primary" href="">All<span class="bg-white text-muted ml-2">
                        {{$badge->count()}}
                    </span></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-muted" href="{{route('received-po')}}">Completed<span class="bg-white border text-muted ml-2">
                ...
                <table class="table datatables" id="dataTable-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$q->nama_cv}}</td>
                            <td>{{$q->alamat}}</td>
                            <td><a href="{{route('add-po',$q->id)}}"><button class="btn btn-info">Select</button></a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
                ...
                <table class="table datatables" id="dataTable-3">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td>{{$q->nama_cv}}</td>
                            <td>{{$q->alamat}}</td>
                            <td><a href="{{route('addbypr-po',$q->id)}}"><button class="btn btn-info">Select</button></a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
