                                ...
                                <table class="table table-hover table-bordered" id="myUL">
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="status_mat" id="status_mat" value="pending">
                                                <input type="hidden" name="no_pr" id="no_pr" value="{{$nopr}}">
...
<script type="text/javascript">
    $("#sbmit").click(function(e) {
        ...
        var status_id = $("input[name=status_mat]").val();
        var pr = $("input[name=no_pr]").val();
        var barang_id = $("select[name=package]").val();
        var row = '<tr id="dtl1"><input type="hidden" name="pr[]" id="pr" value=""><input type="hidden" name="harga[]" id="harga' + rate + '" value="' + rate + '"><input type="hidden" name="statusmaterial[]" id="statusmaterial' + status_id + '" value="' + status_id + '"><input type="hidden" name="barangid[]" id="barangid' + barang_id + '" value="' + barang_id + '"><input type="hidden" name="nopr[]" id="nopr' + pr + '" value="' + pr + '"><input type="hidden" name="userid[]" id="userid' + user_id + '" value="' + user_id + '"><td><input type="hidden" name="partno[]" id="partno' + partno + '" value="' + partno + '"><span id="partno' + i_additem + '">' + partno + '</span></td><td><input type="hidden" name="description[]" id="description' + desc + '" value="' + desc + '"><span id="unit' + i_additem + '">' + desc + '</span></td><td><input type="hidden" name="qty_main[]" id="qty_main' + price + '" value="' + price + '"><span id="stok' + i_additem + '">' + price + '</span></td><td><input type="hidden" name="qtyreq[]" id="qtyreq' + qtyreq + '" value="' + qtyreq + '"><span id="qty' + i_additem + '">' + qtyreq + '</span></td><td><center><button type="button" class="btn btn-danger btn-sm" onclick="deleteRow_item(' + no + ',\'' + desc + '\')">Delete<i class="fa fa-close"></i></button></center></td></tr>';
        console.log(row);
