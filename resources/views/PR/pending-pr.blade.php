...
<div class="col-md-12">
        <div class="col-md mb-3">
            <ul class="nav nav-pills justify-content-start">
                ...
                <li class="nav-item">
                    <a class="nav-link text-muted px-2" href="{{route('approved-pr')}}">Approved <span class="bg-white border text-muted ml-2">
                            {{$badge->where('status','=','approved')->count()}}
                        </span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active bg-transparent text-primary px-2" href="{{route('pending-pr')}}">Pending<span class="bg-white border text-muted ml-2">
